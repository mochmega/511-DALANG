    ...
    <div className="flex h-screen bg-slate-950 text-slate-200 font-sans overflow-hidden">
      ...
      <aside className={`${isSidebarOpen ? 'w-72' : 'w-24'} bg-slate-900 border-r border-slate-800/50 flex flex-col transition-all duration-300 shadow-2xl z-20 flex-shrink-0`}>
        ...
        <nav className="flex-1 py-4 flex flex-col overflow-y-auto overflow-x-hidden">
          ...
          <NavItem to="/pencarian" label="Rumah Berkas" isOpen={isSidebarOpen} icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><circle cx="11" cy="11" r="8"/><line x1="21" x2="16.65" y1="21" y2="16.65"/></svg>} />
